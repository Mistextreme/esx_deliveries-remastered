...
Config.Models = {
	...
	van     = 'nspeedod',      -- New Style Transit Van (nspeedo)
	truck   = 'mule',
	vehDoor = {
...
Config.Locales = {
	...
	["start_delivery"]            = "Press ~INPUT_CONTEXT~ to start delivery job",
	...
	["delivery_vehicle_returned"] = "Your vehicle has been return",
